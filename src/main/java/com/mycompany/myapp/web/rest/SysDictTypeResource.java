...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.SysDictType}.
 */
@RestController
@RequestMapping("/api")
public class SysDictTypeResource {
    ...
    public SysDictTypeResource(SysDictTypeService sysDictTypeService) {
    ...
    public ResponseEntity<SysDictType> createSysDictType(@RequestBody SysDictType sysDictType) throws URISyntaxException {
        ...
        SysDictType result = sysDictTypeService.save(sysDictType);
    ...
    public ResponseEntity<SysDictType> updateSysDictType(@RequestBody SysDictType sysDictType) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sysDictType.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<SysDictType>> getAllSysDictTypes(Pageable pageable) {
        ...
        Page<SysDictType> page = sysDictTypeService.findAll(pageable);
    ...
    public ResponseEntity<SysDictType> getSysDictType(@PathVariable Long id) {
        ...
        Optional<SysDictType> sysDictType = sysDictTypeService.findOne(id);
